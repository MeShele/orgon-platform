...
# Admin user CRUD lives in routes_users (mounted at /api/users); see also rbac.py
# for the canonical role list. Frontend calls /api/users/* — no callers of
# /api/auth/users or /api/auth/roles remain.
