...
class SignatureService:
        ...
        try:
            ...
            self._db.execute(
                """INSERT INTO signature_history
                   ...
                   VALUES (?, ?, ?, ?)""",
                (tx_unid, user_address, "signed", datetime.now(timezone.utc).isoformat())
            )
    ...
    def get_statistics(self) -> dict:
        ...
        total_signed = self._db.fetchone(
        ...
        total_rejected = self._db.fetchone(
