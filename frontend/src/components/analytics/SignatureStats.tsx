...
export default function SignatureStats({ data }: SignatureStatsProps) {
  ...
  return (
    <div className="bg-card rounded-xl p-4 sm:p-6 border border-border shadow-sm">
      <h3 className="text-base sm:text-lg font-semibold mb-6 text-foreground flex items-center gap-2">
      ...
      {total === 0 ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="text-center p-2 sm:p-3 bg-success/10 rounded-lg border border-green-100 dark:border-green-800/30">
              <div className="text-xl sm:text-2xl font-bold text-success">{signed}</div>
              <div className="text-xs text-green-700 dark:text-green-500 mt-1">{t('stats.signed')}</div>
            </div>
            
            <div className="text-center p-2 sm:p-3 bg-warning/10 rounded-lg border border-yellow-100 dark:border-yellow-800/30">
            ...
            <div className="text-center p-2 sm:p-3 bg-primary/10 rounded-lg border border-blue-100 dark:border-blue-800/30">
